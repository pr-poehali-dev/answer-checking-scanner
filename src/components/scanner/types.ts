...
export const NAV_ITEMS: { id: Section; label: string; icon: string }[] = [
  ...
  { id: "fipiExams", label: "Готовые варианты", icon: "ScrollText" },
...
export const SECTION_TITLES: Record<Section, string> = {
  ...
  synopsis: "Конспекты",
  exams: "Итоговая аттестация — варианты по официальной структуре",
  fipiExams: "Готовые варианты — без ИИ, мгновенно",
  chat: "Чат с ИИ",
