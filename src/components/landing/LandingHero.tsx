      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative">
        <div className="max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-white/75 mb-8 leading-relaxed max-w-2xl">
            САОУ автоматизирует проверку работ, генерацию тестов, презентаций и конспектов для педагогов — и помогает ученикам готовиться к итоговой аттестации, решать тренировочные тесты и учиться с ИИ-помощником. Всё строго по программе Минпросвещения РФ.
          </p>
