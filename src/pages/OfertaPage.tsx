      ...
      <main className="flex-1 px-6 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs text-muted-foreground mb-8">
            ООО «РАССВЕТ» · ИНН 2907011706 · ОГРН 1062907013707
          </p>

          <Section title="1. Общие положения">
            <p>1.1. Настоящая оферта является публичным предложением (офертой) ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ «РАССВЕТ», далее — «Исполнитель», заключить договор оказания услуг с любым физическим или юридическим лицом, далее — «Заказчик», принявшим условия данной оферты.</p>
          ...
          <Section title="2. Предмет договора">
            ...
            <ul>
              <li>АОУСПТ пакет — доступ ко всем функциям раздела сайта (Искл. Административные панели)</li>
            </ul>
          </Section>
          ...
          <Section title="4. Стоимость и порядок оплаты">
            <p>4.1. Стоимость услуг определяется в соответствии с выбранным тарифным планом.</p>
            ...
            <p>4.3. Оплата производится ежемесячно / ежеквартально / ежегодно (в зависимости от выбранного тарифа).</p>
          </Section>
