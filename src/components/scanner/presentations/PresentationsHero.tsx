    ...
    <div className="relative rounded-xl overflow-hidden" style={{
      ...
      <div className="relative px-6 py-6 text-white">
        ...
        <p className="text-xs opacity-65 max-w-sm leading-relaxed">
          ИИ придумывает уникальное оформление под каждую тему — свои цвета, шрифты,
          вёрстку и декор. Отредактируйте текст и выберите один из 4 вариантов
          дизайна прямо в редакторе перед скачиванием.
        </p>
