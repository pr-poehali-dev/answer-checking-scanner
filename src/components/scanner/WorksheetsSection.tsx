      ...
      <div className="border border-border rounded-xl overflow-hidden shadow-sm"
        ...
        <div className="px-6 py-5 text-white">
          ...
          <p className="text-xs opacity-85 leading-relaxed max-w-2xl">
            Укажите тему, класс, описание и число заданий — ИИ составит выполнимые задания строго по
            программе Минпросвещения РФ. К каждому заданию прикладываются нужные данные: таблицы,
            тексты-источники, карты и фотографии, чтобы ученик мог решить всё прямо на листе.
          </p>
          <div className="flex flex-wrap gap-2 mt-3">
            {["Программа Минпросвещения РФ", "Таблицы и данные", "Карты и фото", "Готов к печати"].map(t => (
